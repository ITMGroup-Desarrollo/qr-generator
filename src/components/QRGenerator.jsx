  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <img
          src={`${import.meta.env.BASE_URL}imagenes/logo-ITM-Group.png`}
          alt="ITM Group"
          style={styles.logo}
        />
              ...
              <div key={i} style={styles.historyCard}>
                <div
                  style={{
                    ...styles.qrPreviewBg,
                    background:
                      entry.qrColor === "#ffffff" ? "#1a2c5b" : "#f0f4f8",
                  }}
                >
                  <img src={entry.dataUrl} alt="QR" style={styles.qrThumb} />
                </div>
      ...
      {modal && (
        <div style={styles.overlay} onClick={() => setModal(null)}>
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={styles.modalUrl}>
              {modal.input.length > 40
                ? modal.input.slice(0, 40) + "..."
                : modal.input}
            </p>
